                ...
                profileLoading ?
                    ...
                    <div className=" w-full
                        ...
                        <div className=" w-full
                            ...
                            <div className="flex md:flex-row  flex-col items-center justify-start gap-8 p-20">
                                <div className="relative">
                                    {
                                        isActive === 'settings'
                                            ...
                                            <form onSubmit={handleUpdateProfile} action="">
                                                <div className="relative w-32 h-32">
                                                    ...
                                                    <label for="fileUpload"
                                                        className="absolute bottom-0 right-0 bg-blue-600 text-white w-8 h-8 flex 
                                            items-center justify-center rounded-full cursor-pointer shadow hover:bg-blue-700 transition">
                                                        +
                                                    </label>
                                                </div>
                                            </form>
                                            ...
                                            :
                                            <img className="rounded-full w-40 h-40  border-black border-2" src={`${user?.picture ||
                                ...
                                <div className="items-center flex flex-col ">
                                    ...
                                    <h1 className="text-gray-700 mb-5  text-center">{user?.department}</h1>
                                ...
                                <div className=" p-2 gap-8 flex flex-col xl:px-4 lg:px-32 md:px-24 ">
                                    {
                                        user?.Vote?.map((item, index) => {
                                            return (
                                                <div data-aos="fade-up" key={index} className="flex cursor-pointer flex-col gap-2 mb-4 border border-gray-200  rounded-xl sm:p-4 p-2">
                                                    <Link key={index} to={`/posts/${item.post.id}`}>
                                                        <div className="flex flex-col gap-2">
                                                            <div className="flex flex-row justify-between items-center">
                                        ...
                                        user?.Comment.map((item) => {
                                            return (
                                                <Link to={`/posts/${item.post.id}`}>
                                                    <div className=" bg-white hover:bg-gray-100 m-2 p-2 transition-all duration-300
                                                     cursor-pointer border border-gray-300 rounded-xl">
                                                            ...
                                                            item.parent !== null
                                                                ...
                                                                <div className="flex flex-col justify-between  mb-1">
                                                                    <div className="flex flex-row gap-3 mb-4">
                                                                        <img className="rounded-full sm:w-12 sm:h-12 w-10 h-10" src={`${item?.parent?.user?.picture || 'https://img.icons8.com/?size=100&id=u4U9G3tGGHu1&format=png&color=000000'}`} alt="" />
                                                                        <div>
                                                                ...
                                                                <div className="flex flex-col justify-between mb-1">
                                                                    <div className="flex flex-row gap-3 mb-4">
                                                                        <img className="rounded-full w-12 h-12" src={`${item?.post.user.picture || 'https://img.icons8.com/?size=100&id=u4U9G3tGGHu1&format=png&color=000000'}`} alt="" />
                                                                        <div>
                                                        ...
                                                        <div className="ml-8 flex flex-col gap-4">
                                                            <div className="flex flex-row items-center gap-2">
                                                                <img className="rounded-full w-8 h-8 border-black border" src={`${user?.picture || 'https://img.icons8.com/?size=100&id=u4U9G3tGGHu1&format=png&color=000000'}`} alt="" />
                                                                <div>
                        ...
                        }
                        {
                         ...
                         transition-colors duration-1000 cursor-pointer flex flex-row items-center gap-1
                                ">
